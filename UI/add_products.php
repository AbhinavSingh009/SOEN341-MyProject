          ...
          <form method="post" action="#updatePost/">
            ...
            <fieldset>
              <table class="data-table cart-table" id="shopping-cart-table">
                ...
                <thead>
                  <tr class="first last">
                    ...
                    <th rowspan="1" class="movewishlist"></th>
                ...
                <tfoot>
                  <tr class="first last">
                     <td class="a-right last" colspan="7">
						  <!--<button onclick="setLocation('#/')" class="button btn-continue" title="Continue Shopping" type="button"><span>Continue Shopping</span></button> --> <!--
                        <button class="button btn-update" title="Update Shopping Cart" value="update_qty" name="update_cart_action" type="submit"><span>Modify Product</span></button>
                        <button id="empty_cart_button" class="button btn-danger" title="Clear Shopping Cart" value="empty_cart" name="update_cart_action" type="submit"><span>Delete Product(s)</span></button>-->
</td>
                    </tr>
                </tfoot>
                <tbody>
                  <tr class="first odd">
                    <td class="a-center"><a class="remove-item" title="Remove item" href="#/checkout/cart/delete/id/10963/uenc/aHR0cDovL21hZ2VudG8ubWFnaWt0aGVtZXMuY29tL21hZ2lrdmlzdGEvY2hlY2tvdXQvY2FydC8,/"><span>Remove item</span></a></td>
                    <td class="a-center cart-img hidden-table"><a class="product-image" title="Sample Product" href="product_detail.html"><img width="75" alt="Horny Toad Women's Marley Short" src="products-images/product1.jpg"></a></td>
                    <td><h2 class="product-name"> <a href="product_detail.html">Sample Product</a> </h2></td>
                    <td class="a-center hidden-table"><a title="Edit item parameters" class="edit-bnt" href="#/checkout/cart/configure/id/10963/"></a></td>
                    <td class="a-right hidden-table"><span class="cart-price"> <span class="price">$29.00</span> </span></td>
                    <td class="a-center movewishlist hidden-table"><input maxlength="12" class="input-text qty" title="Qty" size="4" value="2" name="cart[10963][qty]"></td>
                    <td class="a-center movewishlist last"><span class="cart-price"> <span class="price">$58.00</span> </span></td>
                  </tr>
              ...
              <tr class="first odd">
                  ...
                  <tr class="last even">
                    <td class="a-center"><a class="remove-item" title="Remove item" href="#/checkout/cart/delete/id/10964/uenc/aHR0cDovL21hZ2VudG8ubWFnaWt0aGVtZXMuY29tL21hZ2lrdmlzdGEvY2hlY2tvdXQvY2FydC8,/"><span>Remove item</span></a></td>
                    <td class="a-center cart-img hidden-table"><a class="product-image" title="Sample Product" href="product_detail.html"><img width="75" alt="Billabong Women's Golden" src="products-images/product1.jpg"></a></td>
                    <td><h2 class="product-name"> <a href="product_detail.html">Sample Product</a> </h2></td>
                    <td class="a-center hidden-table"><a title="Edit item parameters" class="edit-bnt" href="#/checkout/cart/configure/id/10964/"></a></td>
                    <td class="a-right hidden-table"><span class="cart-price"> <span class="price">$24.00</span> </span></td>
                    <td class="a-center movewishlist hidden-table"><input maxlength="12" class="input-text qty" title="Qty" size="4" value="1" name="cart[10964][qty]"></td>
                    <td class="a-center movewishlist last"><span class="cart-price"> <span class="price">$24.00</span> </span></td>
                  </tr>
                </tbody>
              </table>
            </fieldset>
...
<ul class="form-list">
                    ...
                    <li>
                      ...
                      <div class="input-box">
                       <!-- <select style="" title="State/Province" name="region_id" class="required-entry validate-select">
   ...
   <!--<h3>Shopping Cart Total</h3>-->
          <div class="inner">
            <table id="shopping-cart-totals-table">
              ...
              <tfoot>
                <tr>
<td class="a-right" style=""><strong></strong></td>
                </tr>
              </tfoot>
              <tbody>
                <tr>
<td class="a-right" style="">&nbsp;</td>
                </tr>
              </tbody>
            </table>
            <ul class="checkout">
              <li>
                <button class="button btn-proceed-checkout" title="Proceed to Checkout" type="button"><span>Add Products</span></button>
              </li>
              <li> </li>
            </ul>
              ...
              <div class="item-inner">
                ...
                <div class="item-info">
                  ...
                  <div class="actions">
                    ...
                    <span class="add-to-links"> <a href="#" class="link-wishlist" title="Add to Wishlist"><span>Add to Wishlist</span></a> <a href="#" class="link-compare" title="Add to Compare"><span>Add to Compare</span></a></span> </div>
                </div>
              </div>
            </div>
          </div>-->
