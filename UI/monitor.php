      ...
      <div class="nav-inner">
        ...
        <ul id="nav" class="hidden-xs">
         ...
         <!-- <li class="level0 nav-7 level-top parent"> <a href="grid.html" class="level-top"> <span>Computers</span> </a>
          ...
          <li class="level0 nav-6 level-top parent"> <a href="desktop.php" class="level-top"> <span>Desktop</span> </a>

          </li>
          <li class="level0 nav-7 level-top parent"> <a class="level-top" href="laptop.php"> <span>Laptop</span> </a>

          </li>
          <li class="level0 nav-8 level-top"> <a href="monitor.php" class="level-top"> <span>Monitor</span> </a> </li>
         <!-- <li class="level0 nav-8 level-top"> <a href="grid.html" class="level-top"> <span>Product</span> </a> </li> -->

			<li class="level0 nav-8 level-top"> <a href="tablet.php" class="level-top"> <span>Tablet</span> </a> </li>
        </ul>
...
$products = array();
$products[] = $lmapper -> get();
$products[] = $dmapper -> get();
$products[] = $tmapper -> get();
